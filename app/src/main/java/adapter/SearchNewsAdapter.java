...
public class SearchNewsAdapter extends RecyclerView.Adapter<SearchNewsAdapter.MyHodler>
    ...
    public SearchNewsAdapter(List<NewsBean.NewslistBean> list, Context context) {
        this.list = list;
