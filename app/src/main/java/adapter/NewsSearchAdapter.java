...
public class NewsSearchAdapter extends RecyclerView.Adapter<NewsSearchAdapter.MyHodler>
    ...
    public NewsSearchAdapter(List<NewsBean.NewslistBean> list, Context context) {
        this.list = list;
